...
--> statement-breakpoint
ALTER TABLE `users` MODIFY COLUMN `role` enum('super_admin','parent','baby') NOT NULL DEFAULT 'parent';--> statement-breakpoint
...
ALTER TABLE `users` ADD `sharingEnabled` boolean DEFAULT false NOT NULL;--> statement-breakpoint
