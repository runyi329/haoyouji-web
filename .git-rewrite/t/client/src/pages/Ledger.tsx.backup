                ...
                <div className="px-4 py-4">
                  ...
                  <div className="mb-3">
                    <div className="flex items-center gap-2 mb-1.5">
                      ...
                      <h3 className="font-bold text-lg text-gray-900 truncate">{ledger.name}</h3>
                      {ledger.isVip === true && (
                  ...
                  <div className="grid grid-cols-3 gap-2">
                    {activeTab === "active" && (
                      <>
                        <button
                          className="text-xs h-8 rounded-xl bg-gray-50 text-gray-600 font-medium hover:bg-gray-100 transition-colors"
                          onClick={(e) => {
                            e.stopPropagation();
                        ...
                        <button
                          className="text-xs h-8 rounded-xl bg-red-50 text-red-500 font-medium hover:bg-red-100 transition-colors"
                          onClick={(e) => {
                            e.stopPropagation();
                    ...
                    {activeTab === "archived" && (
                      <>
                        <button
                          className="text-xs h-8 rounded-xl bg-gray-50 text-gray-600 font-medium hover:bg-gray-100 transition-colors col-span-2"
                          onClick={(e) => {
                            e.stopPropagation();
                            handleExport(ledger.id);
                          }}
      ...
      <div className="fixed bottom-0 left-0 right-0 z-50">
        <div className="max-w-md mx-auto px-4 pb-4 pt-3 bg-white border-t border-gray-100 shadow-[0_-4px_6px_-1px_rgba(0,0,0,0.05)]">
          <div className="flex gap-3">
            <button
              className="flex-1 py-2.5 rounded-xl text-sm font-medium bg-red-50 text-[#A80000] hover:bg-red-100 transition-colors shadow-sm"
              onClick={() => {
                // TODO: 加入他人账本
              }}
            >
