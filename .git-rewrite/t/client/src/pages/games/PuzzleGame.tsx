        ...
        {!gameStarted ? (
                  ...
                  <button
                    ...
                    className={`w-14 h-14 rounded-xl text-3xl transition-all ${
                      selectedImage.id === img.id
                        ? "bg-[#F5F5F5] ring-2 ring-blue-500 scale-110"
                        : "bg-muted hover:bg-[#F5F5F5]"
                    }`}
                  >
                    {img.emoji}
                  </button>
          ...
          <div className="text-center py-12">
            ...
            <Card className="p-6 mb-4 bg-gradient-to-br from-blue-50 to-cyan-50 border-0 max-w-sm mx-auto">
              <div className="grid grid-cols-3 gap-4 text-center">
                <div>
                  <div className="text-2xl font-bold text-[#1976D2]">{score}</div>
          ...
          <>
            ...
            <div className="flex justify-between items-center mb-3">
              <div className="flex items-center gap-4">
                <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#F5F5F5]">
                  ...
                  <span className="text-sm font-medium text-[#1976D2]">{score}</span>
                </div>
                <div className="flex items-center gap-2 px-3 py-1.5 rounded-full bg-[#E8F5E9]">
                  <Clock className="w-4 h-4 text-[#4CAF50]" />
                  <span className="text-sm font-medium text-[#4CAF50]">{formatTime(elapsedTime)}</span>
                </div>
              </div>
            ...
            <div className="flex justify-center mb-4">
              <div className="px-4 py-2 rounded-full bg-[#F5F5F5] flex items-center gap-2">
                <span className="text-2xl">{selectedImage.emoji}</span>
                <span className="text-sm text-[#1976D2]">拼出{selectedImage.name}</span>
              </div>
            </div>
