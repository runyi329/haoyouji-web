...
const Af525SwitchPage = lazy(() => import("./pages/Af525SwitchPage"));
...
const OtherCoinsPage = lazy(() => import("./pages/OtherCoinsPage"));
...
const LivePriceAdmin = lazy(() => import("./pages/LivePriceAdmin"));
...
// 智能财务汇总入口页
const SmartFinancePage = lazy(() => import("./pages/SmartFinancePage"));
// 社保×AI 页面
...
const TaxDataPage = lazy(() => import("./pages/TaxDataPage"));
...
const HKStockTracker = lazy(() => import("./pages/HKStockTracker"));
const USStockTracker = lazy(() => import("./pages/USStockTracker"));
const USStockLifecycle = lazy(() => import("./pages/USStockLifecycle"));
const USStockDetail = lazy(() => import("./pages/USStockDetail"));
  ...
  return (
    <Suspense fallback={<LoadingFallback />}>
      <Switch>
        ...
        <Route path="/admin/ai-wallet" component={lazy(() => import("./pages/admin/AiWalletManager"))} />
        ...
        <Route path="/policy-loans"><Redirect to="/credit-cards" /></Route>
        ...
        <Route path="/wallet/crypto-transactions" component={CryptoWalletTransactions} />
        ...
        <Route path="/ledger/:id/af-525-switch" component={Af525SwitchPage} />
        ...
        <Route path="/ledger/:id/live-price-admin" component={LivePriceAdmin} />
        ...
        <Route path="/work-log" component={WorkLogPage} />
        ...
        <Route path="/hk-stock-tracker" component={HKStockTracker} />
        <Route path="/us-stock-tracker" component={USStockTracker} />
        <Route path="/us-stock-tracker/stock-lifecycle" component={USStockLifecycle} />
        <Route path="/us-stock/:tsCode" component={USStockDetail} />
        ...
        {/* 智能财务汇总入口 */}
        <Route path="/smart-finance" component={SmartFinancePage} />
        {/* 社保×AI 页面 */}
        <Route path="/social-security" component={SocialSecurityPage} />
        {/* 医疗×AI 页面 */}
        ...
        <Route path="/tax-data" component={TaxDataPage} />
        ...
        <Route path="/yaban/features/customize" component={lazy(() => import("./pages/yaban/YabanFeaturesCustomize"))} />
        ...
        <Route path="/yaban/staff-profile" component={lazy(() => import("./pages/yaban/YabanStaffProfile"))} />
        <Route path="/yaban/staff" component={lazy(() => import("./pages/yaban/YabanStaffDashboard"))} />
        <Route path="/yaban/staff/:id" component={lazy(() => import("./pages/yaban/YabanStaffDetail"))} />
        <Route path="/yaban/my" component={lazy(() => import("./pages/yaban/YabanMyPage"))} />
        <Route path="/yaban/partner-profile" component={lazy(() => import("./pages/yaban/YabanPartnerProfile"))} />
        <Route path="/yaban/ai-valuation" component={lazy(() => import("./pages/yaban/YabanAiValuation"))} />
        ...
        <Route path="/yaban/shop/admin/fulfill" component={lazy(() => import("./pages/yaban/YabanShopAdminFulfill"))} />
        <Route path="/yaban/shop/admin/coupons" component={lazy(() => import("./pages/yaban/YabanShopAdminCoupons"))} />
        ...
        <Route path="/yaban/enterprise" component={lazy(() => import("./pages/yaban/YabanEnterprise"))} />
        ...
        <Route path="/yaban/settings/homepage-display" component={lazy(() => import("./pages/yaban/YabanHomepageSettings"))} />
        <Route path="/yaban/settings/appt-config" component={lazy(() => import("./pages/yaban/YabanApptConfig"))} />
        ...
        <Route path="/yaban/settings/room-dept" component={lazy(() => import("./pages/yaban/YabanRoomDeptSettings"))} />
        ...
        <Route path="/yaban/clinic-shift" component={lazy(() => import("./pages/yaban/YabanClinicShift"))} />
        <Route path="/yaban/ops-report" component={lazy(() => import("./pages/yaban/OpsReport"))} />
        <Route path="/yaban/patient/create" component={YabanPatientCreate} />
        <Route path="/yaban/patients" component={YabanPatientList} />
        <Route path="/yaban/patient/:id/profile" component={lazy(() => import("./pages/yaban/YabanPatientProfile"))} />
        <Route path="/yaban/patient/:id/media" component={lazy(() => import("./pages/yaban/YabanPatientMedia"))} />
        <Route path="/yaban/charge" component={lazy(() => import("./pages/yaban/YabanTodayCharges"))} />
        ...
        <Route path="/yaban/patient/:id/treatment/create" component={lazy(() => import("./pages/yaban/YabanTreatmentCreate"))} />
        <Route path="/yaban/patient/:id/treatment/:tid" component={lazy(() => import("./pages/yaban/YabanTreatmentCreate"))} />
        <Route path="/yaban/patient/:id/treatment" component={lazy(() => import("./pages/yaban/YabanTreatmentList"))} />
        <Route path="/yaban/wechat-chat" component={lazy(() => import("./pages/yaban/YabanWechatChat"))} />
