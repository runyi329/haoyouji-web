...
const CAROUSEL_IMAGES = [
  { src: "https://haoyouji-images-1396946788.cos.ap-shanghai.myqcloud.com/assets/fidencio-compressed_26249364.webp", alt: "飞腾干红葡萄酒 FIDENCIO RESERVA · 主图" },
  ...
  return (
    <div className="min-h-screen bg-[#0d0505] text-[#e8d5b7] pb-28">
      ...
      <div className="mt-2">
        ...
        <img
          src="https://haoyouji-images-1396946788.cos.ap-shanghai.myqcloud.com/assets/fidencio-compressed_26249364.webp"
