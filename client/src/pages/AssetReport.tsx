...
function ListItem({ 
  ...
  const getTagColor = (tag?: string) => {
    ...
    return "bg-gray-200 text-[#757575]";
  };
    ...
    <div ref={itemRef} className="bg-white">
      ...
      >
        ...
        <div className="flex-1 px-3">
          <span className="text-[#424242] text-sm">{item.title}</span>
        </div>
        ...
        <div className="flex items-center space-x-2 flex-shrink-0">
          ...
          <ChevronDown 
            className={`w-4 h-4 text-[#757575] transition-transform duration-300 ${
