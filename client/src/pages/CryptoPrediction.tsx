...
// BTC/ETH 基于 Yahoo Finance 5年日线（2021-2026，1826天）计算
// SOL 暂用 ETH 数据替代
const HIST_PROB: Record<string, { up: number[]; down: number[] }> = {
  BTC: {
    up:   [0.2333, 0.1333, 0.0833, 0.0367, 0.0667, 0.0333, 0.0333, 0.0077, 0.0027, 0.0049, 0.0033, 0.0016],
    down: [0.2286, 0.1778, 0.0905, 0.1333, 0.0222, 0.0170, 0.0111, 0.0055, 0.0027, 0.0016, 0.0016, 0.0016],
  },
  ETH: {
    up:   [0.1918, 0.1167, 0.1000, 0.0504, 0.0667, 0.0292, 0.0333, 0.0333, 0.0333, 0.0044, 0.0167, 0.0056],
    down: [0.2000, 0.1167, 0.0877, 0.1333, 0.0778, 0.0333, 0.0200, 0.0222, 0.0096, 0.0111, 0.0027, 0.0022],
  },
  SOL: {
    up:   [0.1918, 0.1167, 0.1000, 0.0504, 0.0667, 0.0292, 0.0333, 0.0333, 0.0333, 0.0044, 0.0167, 0.0056],
    down: [0.2000, 0.1167, 0.0877, 0.1333, 0.0778, 0.0333, 0.0200, 0.0222, 0.0096, 0.0111, 0.0027, 0.0022],
