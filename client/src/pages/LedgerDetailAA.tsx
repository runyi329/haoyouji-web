    ...
    <div className="h-screen flex flex-col" style={{ backgroundColor: "#FAF3ED" }}>
      ...
      {selectedTagId === null && (
        <div className="flex-1 overflow-y-auto" style={{ WebkitOverflowScrolling: 'touch' }}>
          ...
          {/* 表头 */}
          <div className="flex items-center" style={{ borderBottom: '1px solid #F5F5F5', minWidth: 400 }}>
            <div style={{ flexShrink: 0, width: 'fit-content', minWidth: 60, maxWidth: 90 }} className="px-2 py-1.5 text-[10px] font-medium text-center"><span style={{ color: '#9E9E9E' }}>名称</span></div>
            <div className="w-px self-stretch" style={{ backgroundColor: '#F0F0F0' }} />
            <div style={{ flex: 0.8, minWidth: 0 }} className="px-2 py-1.5 text-center text-[10px] font-medium"><span style={{ color: '#9E9E9E' }}>周期</span></div>
            <div className="w-px self-stretch" style={{ backgroundColor: '#F0F0F0' }} />
            <div style={{ flex: 1.2, minWidth: 0 }} className="px-2 py-1.5 text-center text-[10px] font-medium"><span style={{ color: '#9E9E9E' }}>金额</span></div>
            <div className="w-px self-stretch" style={{ backgroundColor: '#F0F0F0' }} />
            <div style={{ flex: 1.2, minWidth: 0 }} className="px-2 py-1.5 text-center text-[10px] font-medium"><span style={{ color: '#9E9E9E' }}>回报</span></div>
            <div className="w-px self-stretch" style={{ backgroundColor: '#F0F0F0' }} />
            <div style={{ flex: 0.9, minWidth: 0 }} className="px-2 py-1.5 text-center text-[10px] font-medium"><span style={{ color: '#9E9E9E' }}>年化</span></div>
            <div className="w-px self-stretch" style={{ backgroundColor: '#F0F0F0' }} />
            <div style={{ flex: 1, minWidth: 0 }} className="px-2 py-1.5 text-center text-[10px] font-medium"><span style={{ color: '#9E9E9E' }}>分红</span></div>
          </div>
          {/* 表格每行 */}
          {allTagsChartData
            ...
            .map((tag, idx, arr) => {
              ...
              return (
                <div
                  ...
                  style={{ borderBottom: isLast ? 'none' : '1px solid #F9F9F9', minWidth: 400 }}
                >
                  {/* 标签名称 - 自适应宽度 */}
                  <div style={{ flexShrink: 0, width: 'fit-content', minWidth: 60, maxWidth: 90 }} className="px-2 py-2.5 flex items-center justify-center gap-1">
                    <span style={{ display: 'inline-block', width: 6, height: 6, borderRadius: '50%', backgroundColor: tag.color, flexShrink: 0 }} />
                    <span className="text-xs font-medium" style={{ color: '#1A1A1A', whiteSpace: 'nowrap' }}>{tag.name}</span>
                  </div>
                  <div className="w-px self-stretch" style={{ backgroundColor: '#F0F0F0' }} />
                  {/* 周期 */}
                  <div style={{ flex: 0.8, minWidth: 0 }} className="px-2 py-2.5 text-right text-xs"><span style={{ color: '#424242' }}>{days > 0 ? days : '--'}</span></div>
                  <div className="w-px self-stretch" style={{ backgroundColor: '#F0F0F0' }} />
                  {/* 金额 */}
                  <div style={{ flex: 1.2, minWidth: 0 }} className="px-2 py-2.5 flex flex-col items-end justify-center">
                    {tag.marginCny > 0 ? (
                      <>
                        <div className="text-xs leading-none" style={{ color: '#424242' }}>¥{tag.marginCny.toLocaleString('zh-CN', { maximumFractionDigits: 0 })}</div>
                  ...
                  {/* 回报 */}
                  <div
                    style={{ flex: 1.2, minWidth: 0, color: latestPnl > 0 ? '#D32F2F' : latestPnl < 0 ? '#388E3C' : '#BDBDBD' }}
                  ...
                  {/* 年化 */}
                  <div
                    style={{ flex: 0.9, minWidth: 0, color: annualized === null ? '#BDBDBD' : annualized >= 0 ? '#D32F2F' : '#388E3C' }}
                    className="px-2 py-2.5 text-right text-xs"
                  >
                  ...
                  {(() => {
                    ...
                    return (
                      <div style={{ flex: 1, minWidth: 0, color: divAmt > 0 ? '#D32F2F' : '#BDBDBD' }} className="px-2 py-2.5 text-right text-xs">
          ...
          {(() => {
            ...
            return (
              <div className="flex items-center" style={{ borderTop: '1px solid #F0F0F0', backgroundColor: '#FAFAFA', borderRadius: '0 0 16px 16px', minWidth: 400 }}>
                ...
                <div className="w-px self-stretch" style={{ backgroundColor: '#F0F0F0' }} />
                {/* 汇总-周期 */}
                <div style={{ flex: 0.8, minWidth: 0 }} className="px-2 py-2.5 text-right">
                  <span className="text-xs" style={{ color: '#BDBDBD' }}>--</span>
                </div>
                <div className="w-px self-stretch" style={{ backgroundColor: '#F0F0F0' }} />
                {/* 汇总-金额 */}
                <div style={{ flex: 1.2, minWidth: 0 }} className="px-2 py-2.5 text-right">
                ...
                <div className="w-px self-stretch" style={{ backgroundColor: '#F0F0F0' }} />
                {/* 汇总-年化 */}
                <div style={{ flex: 0.9, minWidth: 0 }} className="px-2 py-2.5 text-right">
                ...
                {(() => {
                  ...
                  return (
                    <div style={{ flex: 1, minWidth: 0 }} className="px-2 py-2.5 text-right">
                      <span className="text-xs font-semibold" style={{ color: totalDividend > 0 ? '#D32F2F' : '#BDBDBD' }}>
