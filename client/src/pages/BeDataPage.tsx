...
const ALL_SYMBOLS = [
  { key: "BTCUSDT", label: "比特币 Bitcoin", shortLabel: "BTC",  icon: "https://haoyouji-images-1396946788.cos.ap-shanghai.myqcloud.com/assets/icons/btc-circle-icon.webp", type: "crypto", symbol: "BTCUSDT" },
  { key: "ETHUSDT", label: "以太坊 Ethereum", shortLabel: "ETH",  icon: "https://haoyouji-images-1396946788.cos.ap-shanghai.myqcloud.com/assets/icons/eth-circle-icon.webp", type: "crypto", symbol: "ETHUSDT" },
  { key: "SOLUSDT", label: "索拉纳 Solana", shortLabel: "SOL",  icon: "https://haoyouji-images-1396946788.cos.ap-shanghai.myqcloud.com/assets/icons/sol-circle-icon.webp", type: "crypto", symbol: "SOLUSDT" },
