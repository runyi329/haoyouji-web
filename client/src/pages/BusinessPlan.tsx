    ...
    <div className="min-h-screen bg-cream pb-20">
      ...
      <div className="p-4 space-y-4">
        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden">
          <div className="bg-brand-red px-6 py-8 text-center">
        ...
        {/* 卡片2：现状与挑战 */}
        <div className="bg-white rounded-xl shadow-sm overflow-hidden">
          <div className="bg-brand-red px-6 py-6">
        ...
        <div className="bg-white rounded-xl shadow-sm overflow-hidden">
          ...
          <div className="p-6">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div className="bg-cream rounded-lg p-5">
                <div className="w-10 h-10 bg-brand-red text-white rounded-full flex items-center justify-center font-bold mb-3">
                  01
                </div>
              ...
              <div className="bg-cream rounded-lg p-5">
                <div className="w-10 h-10 bg-brand-gold text-white rounded-full flex items-center justify-center font-bold mb-3">
                  02
                </div>
          ...
          <div className="p-6 space-y-6">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div className="border border-gray-200 rounded-lg p-4 hover:border-brand-red transition-colors">
            ...
            <div>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                <div className="border border-gray-200 rounded-lg p-4 hover:border-brand-gold transition-colors">
