              ...
              {selectedCompany ? (
                <div className="flex flex-col gap-2">
                  ...
                  <div className="flex items-center gap-3">
                    <div className="flex-1 min-w-0 text-base font-bold text-[#1A2B4A] leading-tight" style={{ wordBreak: 'break-all' }}>{selectedCompany.name}</div>
                  ...
                  {selectedCompany.taxNo && (
                    <div className="flex items-center gap-3">
                      <div className="flex-1 min-w-0 text-base font-bold text-[#1A2B4A] leading-tight" style={{ wordBreak: 'break-all' }}>{selectedCompany.taxNo}</div>
            ...
            <table className="w-full text-[10px] border-collapse" style={{ borderBottom: '2px solid #1A3A5C' }}>
              ...
              <tbody>
                <tr style={{ background: '#fff' }}>
                  ...
                  <td className="px-0.5 py-1 text-center border-r border-gray-200 text-[#444] whitespace-nowrap text-[9px]">待AI会计确认</td>
                  <td className="px-1 py-1 border-r border-gray-200 text-[#444] text-[9px]">待AI会计确认</td>
