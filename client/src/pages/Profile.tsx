...
export default function Profile() {
  ...
  const accountFeatures: FeatureItem[] = [
    ...
    { id: "privacy", icon: Settings, label: "隐私设置", color: "bg-slate-100 text-slate-600", badge: null, onClick: () => { if (user.role === "super_admin") { navigate("/admin/projects"); } else { toast("功能开发中"); } } },
  ];
          ...
          <div className="flex-1 min-w-0">
            ...
            <div className="flex items-center gap-2 mt-1.5 flex-wrap">
              ...
              {user.walletEnabled === 1 && (
                <span className="inline-flex items-center gap-1 px-2 py-0.5 rounded-full text-xs font-medium bg-white/20 text-white cursor-pointer" onClick={() => navigate('/wallet')}>
