...
export default function Profile() {
  ...
  const accountFeatures: FeatureItem[] = [
    ...
    { id: "manus-chat", icon: MessageCircle, label: "Manus", color: "bg-gradient-to-br from-[#A80000] to-[#d44] text-white", badge: manusUnread?.count || null, onClick: () => navigate("/manus") },
