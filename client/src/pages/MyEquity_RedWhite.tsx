      ...
      <div className="max-w-md mx-auto py-4 space-y-4">
        ...
        <div className="space-y-0">
            ...
            <Tooltip
              ...
              content={
                <div className="space-y-1.5">
                  <div className="font-bold text-[#D32F2F] text-base pb-1.5 border-b border-[#E0E0E0]">综合股权构成</div>
                  <div className="text-sm text-[#424242] leading-snug space-y-1">
                    <div className="py-1.5 border-b border-[#E0E0E0]">
                      ...
                      <span className="text-[#424242]"> — 投资额度×入场系数，锁定终身，不与劳动挂钩</span>
                    </div>
                    <div className="py-1.5 border-b border-[#E0E0E0]">
                      <span className="font-semibold text-[#D32F2F]">市场贡献池（12.5%）</span>
                      <span className="text-[#424242]"> — 每周行为贡献结算，多劳多得，上不封顶</span>
                    </div>
          ...
          <div className="bg-white px-4 py-4 rounded-b-2xl shadow-sm mx-4">
            ...
            <div>
              <div className="space-y-3">
                ...
                <div className="flex items-center justify-between">
                  <span ref={multiplierTitleRef} className="text-sm text-[#424242] font-semibold">当前股权加速</span>
                  <div className="relative">
                    ...
                    <Tooltip
                      ...
                      content={
                        <div className="space-y-1.5">
                          <div className="font-bold text-[#D32F2F] text-base pb-1.5 border-b border-[#E0E0E0]">收益加速规则</div>
                          <div className="text-sm text-[#424242] leading-snug space-y-1">
                            <div className="py-1.5 border-b border-[#E0E0E0]">
                              <span className="font-semibold text-[#D32F2F]">资本杠杆</span>
                              <span className="text-[#424242]"> — 投资金额×入场顺序，一次性锁定</span>
                            </div>
                            <div className="py-1.5 border-b border-[#E0E0E0]">
                              <span className="font-semibold text-[#D32F2F]">贡献加速</span>
                              <span className="text-[#424242]"> — 节点等级（标准/高级/超级）决定</span>
                            </div>
                            <div className="py-1.5 text-[#424242]">
                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div className="bg-white rounded-lg py-3 px-2">
                      <GaugeChart
                        ...
                        color="#A80000"
                      />
                      <div className="text-[9px] text-[#757575] mt-1 text-center">
            ...
            {/* 数据加密保护提示 */}
            <div className="text-center text-[10px] text-[#757575] pt-2">
        ...
        <div className="space-y-0">
          ...
          <div className="bg-gradient-to-br from-[#A80000] to-[#8a0000] text-white px-4 py-4">
            ...
            <Tooltip
              ...
              content={
                <div className="space-y-1.5">
                  <div className="font-bold text-[#D32F2F] text-base pb-1.5 border-b border-[#E0E0E0]">天使股东池（30%）</div>
                  <div className="text-sm text-[#424242] leading-snug space-y-1">
                    <div className="py-1.5 border-b border-[#E0E0E0]">
                      <span className="font-semibold text-[#D32F2F]">分配逻辑</span>
                      <span className="text-[#424242]"> — 入场早晚×投资额度双重加权，系数从2.0递减至1.0</span>
                    </div>
                    <div className="py-1.5 text-[#424242]">
          ...
          <div className="bg-white px-4 py-6 rounded-b-3xl mx-4">
            ...
            <div className="text-center">
              ...
              <div className="flex items-center justify-center space-x-1 mb-4">
                <span ref={leverageTitleRef} className="text-xs text-[#757575]">资本加速（风险补偿）</span>
                <button
                  ref={leverageHelpRef}
            ...
            <Tooltip
                ...
                content={
                  <div className="space-y-1.5">
                    <div className="font-bold text-[#D32F2F] text-base pb-1.5 border-b border-[#E0E0E0]">资本加速（风险补偿）</div>
                    <div className="text-sm text-[#424242] leading-snug space-y-1">
                      <div className="py-1.5 border-b border-[#E0E0E0]">
                        <span className="font-semibold text-[#D32F2F]">风险补偿</span>
                        <span className="text-[#424242]"> — 早期投资者承担更大风险，按公平原则享受更多权益</span>
                      </div>
                      <div className="py-1.5 border-b border-[#E0E0E0]">
                        <span className="font-semibold text-[#D32F2F]">初始投资放大</span>
                        <span className="text-[#424242]"> — 投资额×系数=天使池权重。例：10万×2.0x=20万权重</span>
                      </div>
                      <div className="py-1.5 border-b border-[#E0E0E0]">
                        <span className="font-semibold text-[#D32F2F]">市场贡献放大</span>
                        <span className="text-[#424242]"> — 每周贡献也乘以该系数。例：系数1.5x，贡献权益×1.5</span>
                      </div>
                      <div className="py-1.5 text-[#424242]">
          ...
          <div className="bg-[#FAF3ED] px-4 py-4 rounded-b-3xl space-y-3 mx-4">
            ...
            <div className="bg-white rounded-xl p-4 shadow-sm border border-[#E0E0E0]">
              <div className="flex items-center space-x-1 mb-3">
                ...
                <span ref={companyEquityTitleRef} className="text-sm font-semibold text-[#424242]">公司股权分配</span>
                <button
              ...
              <Tooltip
                ...
                content={
                  <div className="space-y-1.5">
                    <div className="font-bold text-[#D32F2F] text-base pb-1.5 border-b border-[#E0E0E0]">双池设计原理</div>
                    <div className="text-sm text-[#424242] leading-snug space-y-1">
                      <div className="py-1.5 border-b border-[#E0E0E0]">
                        <span className="font-semibold text-[#D32F2F]">资产安全性</span>
                        <span className="text-[#424242]"> — 30%天使池不与劳动挂钩，投资安全有保障</span>
                      </div>
                      <div className="py-1.5 border-b border-[#E0E0E0]">
                        <span className="font-semibold text-[#D32F2F]">收益爆发力</span>
                        <span className="text-[#424242]"> — 12.5%市场池激励扩张，平台估值翻倍时静态资产同步增值</span>
                      </div>
                      <div className="py-1.5 text-[#424242]">
            ...
            <div className="bg-white rounded-xl p-4 shadow-sm border border-[#E0E0E0]">
              <div className="flex items-center space-x-1 mb-3">
                ...
                <span className="text-sm font-semibold text-[#424242]">在线签署</span>
              </div>
              <div className="space-y-3">
                <div className="flex items-center justify-between text-sm">
                  <span className="text-[#757575]">签署进度</span>
                  <span className="font-bold text-[#424242]">0%</span>
                </div>
                <div className="flex items-center justify-between text-sm">
                  <span className="text-[#757575]">0/1 份协议</span>
                  <span className="text-xs px-2 py-1 bg-[#CBA471]/10 text-[#CBA471] rounded">待签署</span>
                </div>
                <div className="pt-2 border-t border-[#E0E0E0]">
                  <div className="text-xs text-[#757575] mb-1">电子股权投资协议</div>
            ...
            <div className="bg-white rounded-xl p-4 shadow-sm border border-[#E0E0E0]">
              <div className="flex items-center space-x-1 mb-3">
                ...
                <span className="text-sm font-semibold text-[#424242]">常见问题</span>
              </div>

              <div className="space-y-2">
                <button className="w-full text-left px-3 py-2 bg-gray-50 hover:bg-gray-100 rounded-lg text-sm text-[#424242] transition-colors flex items-center justify-between">
                  <span>1. 我投这点钱到底占多少股？</span>
                  <svg className="w-4 h-4 text-[#757575] flex-shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
