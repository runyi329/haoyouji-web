        ...
        <div className="bg-white rounded-2xl shadow-sm overflow-hidden">
          ...
          {opinionOpen && !submitted && (
            <div className="px-4 pb-4 space-y-4 border-t border-gray-50">
              ...
              {/* Step 4: 图片 + 文字 */}
              <div>
                <p className="text-xs font-semibold text-gray-500 mb-2 uppercase tracking-wide">拍照 / 补充说明（可选）</p>
                ...
                <Textarea
                  ...
                  className="min-h-[70px] text-sm resize-none bg-gray-50 border-gray-100"
                  maxLength={500}
                />
              ...
              {/* 昵称 */}
              <div>
                <p className="text-xs font-semibold text-gray-500 mb-2 uppercase tracking-wide">您的称呼（可选）</p>
                <Input
                  value={guestName}
