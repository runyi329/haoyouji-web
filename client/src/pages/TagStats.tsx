...
export default function TagStats() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-gray-50 to-white pb-20">
      {/* Header */}
      <div className="bg-gradient-to-br from-purple-600 to-purple-700 text-white sticky top-0 z-10 shadow-lg">
      ...
      {isLoading ? (
        ...
        <div className="container mx-auto px-4 py-6 space-y-4">
          {/* 标签总数卡片 */}
          <Card className="bg-gradient-to-br from-purple-500 to-purple-600 text-white p-6 rounded-xl shadow-md border-none">
                ...
                <div key={index} className="flex items-center gap-2">
                  ...
                  <div className="flex-1">
                    <div className="flex items-center justify-between mb-1">
                      ...
                      <span className="text-xs text-gray-600">{t.contacts}人 ({t.percentage}%)</span>
                    </div>
          ...
          {/* 数据洞察 */}
          <Card className="p-4 rounded-xl shadow-sm bg-gradient-to-br from-purple-50 to-blue-50">
            ...
            <div className="space-y-2 text-sm text-gray-700">
              {tagStats.distribution.length > 0 && (
                <>
                  <p>• 最热门标签: <span className="font-semibold text-purple-600">{tagStats.distribution[0].tag}</span>，使用了 {tagStats.distribution[0].contacts} 次</p>
                  {tagStats.matrix.length > 0 && (
                    <>
                      <p>• 最活跃标签: <span className="font-semibold text-purple-600">
                      ...
                      <p>• 人均互动最高: <span className="font-semibold text-purple-600">
          ...
          <div className="grid grid-cols-2 gap-3">
            <Button
              ...
              className="bg-gradient-to-r from-purple-600 to-purple-700 text-white h-12 rounded-xl shadow-md hover:shadow-lg transition-all"
            >
              管理标签
            </Button>
            <Button
              ...
              variant="outline"
              className="h-12 rounded-xl border-2 border-purple-600 text-purple-600 hover:bg-purple-600 hover:text-white transition-all"
            >
              查看人脉
            </Button>
          </div>
