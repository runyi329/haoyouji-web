...
const GAMES: GameConfig[] = [
  ...
  { id: "character_flashcard", name: "快闪识字", icon: "⚡", color: "bg-orange-100", activityPrefix: ["character_flashcard_"], hasDifficulty: true },
  ...
  { id: "math", name: "数学问答", icon: "🔢", color: "bg-yellow-100", activityPrefix: ["math_"] },
  { id: "antonym", name: "反义词", icon: "🔄", color: "bg-emerald-100", activityPrefix: ["antonym_"] },
  { id: "addition20", name: "20加法", icon: "➕", color: "bg-orange-100", activityPrefix: ["addition20_"], hasDifficulty: true },
  
  // 日常任务
  { id: "brushing", name: "刷牙任务", icon: "🪥", color: "bg-sky-100", activityPrefix: ["brushing_"] },
  { id: "knowledge", name: "知识阅读", icon: "📚", color: "bg-amber-100", activityPrefix: ["knowledge_"] },
];

// 难度等级配置
const DIFFICULTY_CONFIG = {
  easy: { name: "简单", color: "bg-green-100 text-green-700 border-green-300" },
  medium: { name: "中等", color: "bg-yellow-100 text-yellow-700 border-yellow-300" },
          ...
          {isEditing ? (
            ...
            <>
              <div className="flex items-center gap-1 px-3 py-1 bg-yellow-50 rounded-full border border-yellow-200">
                <span className="font-bold text-yellow-600">{rule.starsReward}</span>
