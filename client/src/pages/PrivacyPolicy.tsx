    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b border-gray-200 sticky top-0 z-10">
        <div className="max-w-4xl mx-auto px-4 py-4 flex items-center">
          ...
          <h1 className="text-lg font-semibold text-gray-900">隐私条款</h1>
        </div>
      </header>
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-white rounded-lg shadow-sm p-8">
          <div className="prose prose-sm max-w-none">
            ...
            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">引言</h2>
            ...
            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">一、我们如何收集和使用您的个人信息</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
              个人信息是指以电子或者其他方式记录的能够单独或者与其他信息结合识别特定自然人身份或者反映特定自然人活动情况的各种信息。
            </p>

            <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-3">1.1 注册、登录</h3>
            <p className="text-gray-700 leading-relaxed mb-4">
              当您注册、登录脉动及相关服务时，您可以通过手机号创建账号，并且您可以完善相关的网络身份识别信息（头像、昵称、密码），收集这些信息是为了帮助您完成注册。您还可以根据自身需求选择填写性别、生日、地区及个人介绍来完善您的信息。
            </p>

            <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-3">1.2 信息发布</h3>
            <p className="text-gray-700 leading-relaxed mb-4">
              您发布信息、进行评论或互动时，我们将收集您发布的信息，并展示您的昵称、头像、发布内容和信息。
            </p>

            <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-3">1.3 搜索功能</h3>
            <p className="text-gray-700 leading-relaxed mb-4">
              当您使用脉动提供的搜索服务时，我们会收集您的搜索关键字信息、日志记录。为了提供高效的搜索服务，部分前述信息会暂时存储在您的本地存储设备之中。
            </p>

            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">二、我们如何使用Cookie和同类技术</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">三、我们如何共享、转让、公开披露您的个人信息</h2>
            
            <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-3">3.1 共享</h3>
            <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-3">3.2 转让</h3>
            <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-3">3.3 公开披露</h3>
            <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">四、我们如何保护您的个人信息</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">五、您如何管理您的个人信息</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
              按照中国相关的法律、法规、标准，以及其他国家、地区的通行做法，我们保障您对自己的个人信息行使以下权利：
            </p>

            <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-3">5.1 访问您的个人信息</h3>
            <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-3">5.2 更正您的个人信息</h3>
            <p className="text-gray-700 leading-relaxed mb-4">
              当您发现我们处理的关于您的个人信息有错误时，您有权要求我们做出更正。您可以通过"5.1访问您的个人信息"中列明的方式提出更正申请。
            </p>

            <h3 className="text-lg font-semibold text-gray-900 mt-6 mb-3">5.3 删除您的个人信息</h3>
            <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">六、未成年人的个人信息保护</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
              我们非常重视对未成年人个人信息的保护。若您是18周岁以下的未成年人，在使用我们的产品与/或服务前，应事先取得您家长或法定监护人的书面同意。我们根据国家相关法律法规的规定保护未成年人的个人信息。
            </p>

            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">七、本政策如何更新</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
            ...
            <h2 className="text-xl font-bold text-gray-900 mt-8 mb-4">八、如何联系我们</h2>
            <p className="text-gray-700 leading-relaxed mb-4">
