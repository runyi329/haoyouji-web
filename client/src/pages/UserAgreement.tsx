    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <header className="bg-white border-b border-[#E0E0E0] sticky top-0 z-10">
        <div className="max-w-4xl mx-auto px-4 py-4 flex items-center">
          ...
          <h1 className="text-lg font-semibold text-[#424242]">用户协议</h1>
        </div>
      </header>
      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        <div className="bg-white rounded-lg shadow-sm p-8">
          <div className="prose prose-sm max-w-none">
            ...
            <h2 className="text-xl font-bold text-[#424242] mt-8 mb-4">欢迎使用脉动</h2>
            ...
            <h2 className="text-xl font-bold text-[#424242] mt-8 mb-4">一、账号注册与使用</h2>
            
            <h3 className="text-lg font-semibold text-[#424242] mt-6 mb-3">1.1 账号注册</h3>
            <p className="text-[#424242] leading-relaxed mb-4">
              您在使用脉动服务前需要注册一个账号。账号应当使用手机号码绑定注册，请您使用尚未与脉动账号绑定的手机号码，以及未被脉动根据本协议封禁的手机号码注册脉动账号。脉动可以根据用户需求或产品需要对账号注册和绑定的方式进行变更，而无须事先通知用户。
            </p>

            <h3 className="text-lg font-semibold text-[#424242] mt-6 mb-3">1.2 账号使用</h3>
            <p className="text-[#424242] leading-relaxed mb-4">
            ...
            <h3 className="text-lg font-semibold text-[#424242] mt-6 mb-3">1.3 账号安全</h3>
            <p className="text-[#424242] leading-relaxed mb-4">
            ...
            <h2 className="text-xl font-bold text-[#424242] mt-8 mb-4">二、用户行为规范</h2>
            
            <h3 className="text-lg font-semibold text-[#424242] mt-6 mb-3">2.1 信息内容规范</h3>
            <p className="text-[#424242] leading-relaxed mb-4">
            ...
            <h3 className="text-lg font-semibold text-[#424242] mt-6 mb-3">2.2 行为规范</h3>
            <p className="text-[#424242] leading-relaxed mb-4">
              您在使用脉动服务过程中不得从事下列行为：
            </p>
            <ul className="list-disc list-inside text-[#424242] leading-relaxed mb-4 space-y-2">
            ...
            <h2 className="text-xl font-bold text-[#424242] mt-8 mb-4">三、服务的变更、中断或终止</h2>
            <p className="text-[#424242] leading-relaxed mb-4">
            ...
            <h2 className="text-xl font-bold text-[#424242] mt-8 mb-4">四、知识产权</h2>
            <p className="text-[#424242] leading-relaxed mb-4">
            ...
            <h2 className="text-xl font-bold text-[#424242] mt-8 mb-4">五、免责声明</h2>
            <p className="text-[#424242] leading-relaxed mb-4 font-bold">
              您理解并同意，脉动不对因下述任一情况而导致您的任何损害赔偿承担责任，包括但不限于利润、商誉、使用、数据等方面的损失或其他无形损失的损害赔偿：
            </p>
            <ul className="list-disc list-inside text-[#424242] leading-relaxed mb-4 space-y-2 font-bold">
              <li>使用或未能使用本服务；</li>
            ...
            <h2 className="text-xl font-bold text-[#424242] mt-8 mb-4">六、协议的变更</h2>
            <p className="text-[#424242] leading-relaxed mb-4">
            ...
            <h2 className="text-xl font-bold text-[#424242] mt-8 mb-4">七、法律适用与争议解决</h2>
            <p className="text-[#424242] leading-relaxed mb-4">
            ...
            <h2 className="text-xl font-bold text-[#424242] mt-8 mb-4">八、其他</h2>
            <p className="text-[#424242] leading-relaxed mb-4">
            ...
            <h2 className="text-xl font-bold text-[#424242] mt-8 mb-4">九、联系我们</h2>
            <p className="text-[#424242] leading-relaxed mb-4">
