...
export default function LedgerAdminManagement() {
  ...
  if (ledgerData.userRole !== 'owner') {
    return (
      <div className="min-h-screen bg-gray-50 flex items-center justify-center">
        <div className="text-[#757575]">只有账本所有者可以管理管理员</div>
      </div>
    );
  }
    ...
    <div className="min-h-screen bg-gray-50 pb-20">
      ...
      <div className="bg-white border-b border-[#E0E0E0] sticky top-0 z-10">
        <div className="container flex items-center justify-between h-14 px-4">
          ...
          <h1 className="text-lg font-medium text-[#424242]">
            账本管理员管理
          </h1>
      ...
      {/* 说明文字 */}
      <div className="bg-[#F5F5F5] border-l-4 border-[#1976D2] p-4 mt-3 mx-4 rounded-r-lg">
      ...
      <div className="bg-white mt-3 rounded-lg mx-4 overflow-hidden shadow-sm">
        <div className="px-4 py-3 text-sm text-[#757575] border-b border-[#E0E0E0] font-medium">
        ...
        {members?.map((member: any) => (
          <div 
            key={member.userId} 
            className="flex items-center justify-between px-4 py-4 border-b border-[#E0E0E0] last:border-b-0"
          >
            {/* 左侧：头像和信息 */}
            <div className="flex items-center gap-3 flex-1 min-w-0">
              ...
              <div className="flex-1 min-w-0">
                <div className="text-base font-medium text-[#424242] truncate">
              ...
              {member.role === 'owner' ? (
                ...
                <>
                  ...
                  <button
                    ...
                    className="p-2 rounded-full hover:bg-[#FFEBEE] text-[#757575] hover:text-[#D32F2F] transition-colors"
                    title="移除成员"
                  >
      ...
      <div className="bg-white mt-3 rounded-lg mx-4 overflow-hidden shadow-sm">
        ...
        <div className="px-4 py-4 space-y-3 text-sm">
          <div>
            <div className="font-medium text-[#424242] mb-1">创始人</div>
            <div className="text-[#757575]">拥有所有权限，包括删除账本、封存账本、设置管理员等</div>
          </div>
          <div>
            <div className="font-medium text-[#424242] mb-1">管理员</div>
            <div className="text-[#757575]">可以管理报销、审批账目、管理分类等，但不能删除账本或封存账本</div>
          </div>
          <div>
            <div className="font-medium text-[#424242] mb-1">普通成员</div>
            <div className="text-[#757575]">可以添加账目、查看账目、申请报销等基本功能</div>
          </div>
        </div>
      </div>
        ...
        <div className="fixed inset-0 bg-black/50 z-50 flex items-center justify-center p-4">
          <div className="bg-white rounded-2xl w-full max-w-sm overflow-hidden shadow-xl">
            ...
            <div className="flex items-center justify-between px-5 pt-5 pb-2">
              <h3 className="text-lg font-semibold text-[#424242]">确认移除</h3>
              <button
            ...
            <div className="px-5 py-3">
              <p className="text-sm text-[#757575]">
                确定要将 <span className="font-semibold text-[#424242]">{deleteConfirm.username}</span> 从账本中移除吗？
              </p>
            ...
            <div className="flex gap-3 px-5 pb-5 pt-2">
              <button
                onClick={() => setDeleteConfirm({ show: false, userId: 0, username: '' })}
                className="flex-1 py-2.5 rounded-xl text-sm font-medium text-[#424242] bg-gray-100 hover:bg-gray-200 transition-colors"
              >
                取消
              </button>
              <button
