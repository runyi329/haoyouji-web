              ...
              <div className="flex items-start gap-0 mb-3">
                ...
                <div className="flex-1 pr-4">
                  ...
                  <div className="flex items-baseline gap-0">
                    ...
                    {targetProfitCny && !isNaN(parseFloat(targetProfitCny)) && parseFloat(targetProfitCny) > 0 && (
                      <span className="text-3xl font-bold" style={{ background: 'linear-gradient(180deg, #f5e27a 0%, #d4af37 40%, #b8860b 70%, #d4af37 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text', filter: 'drop-shadow(0 2px 4px rgba(0,0,0,0.8))' }}>元</span>
                    )}
                  </div>
                  <div className="flex items-center gap-0 mt-1">
                    ...
                    <span className="text-lg font-semibold" style={{ background: 'linear-gradient(180deg, #d4af37 0%, #9a7a1a 100%)', WebkitBackgroundClip: 'text', WebkitTextFillColor: 'transparent', backgroundClip: 'text' }}>U</span>
                  </div>
                </div>
                {/* 竖分割线 */}
