  ...
  return (
    <div className="min-h-screen bg-cream">
      ...
      <div className="p-4 space-y-4">
        {/* 账本类型显示 */}
        <div className="bg-white-pure rounded-lg p-3 flex items-center gap-3">
          <div className="w-10 h-10 rounded-full bg-blue-100 text-blue-600 flex items-center justify-center flex-shrink-0">
            <Icon className="w-5 h-5" />
          </div>
          <div>
            <div className="text-xs text-gray-500">账本类型</div>
            <div className="text-sm font-medium text-core-black">{typeConfig.name}</div>
          </div>
        </div>

        {/* 账本名称 */}
        <div className="bg-white-pure rounded-lg p-3 space-y-2">
      ...
      <Dialog open={showSuccessDialog} onOpenChange={setShowSuccessDialog}>
        <DialogContent className="w-[85%] max-w-sm" showCloseButton={false}>
          ...
          <DialogDescription className="text-center text-sm text-stable-gray">
            是否去设置或邀请好友加入账本？
          </DialogDescription>
