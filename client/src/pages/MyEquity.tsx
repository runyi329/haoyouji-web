  ...
  const faqs = [
    {
      ...
      answerText: `我们不按传统的"拍脑袋估值"来谈，我们要的是"同舟共济"。

它是动态的增长票
我们现在是初创期，不想随便定个虚高估值套住您，也不想低估公司潜力。这30%是专门给首批天使投资人的"原始红利池"。

您的份额由您的胆识决定
如果本轮我们只需300万就能跑通市场，那您这50万就占了整个天使池的1/6，折合总股本5%。

您有"二次增持"的机会
除了这笔钱，如果您能利用资源帮我们拓展市场（利用那15%的贡献池），您的资金权重会被双倍放大。这意味着，您不仅是出钱的股东，您还是能通过贡献"赚"回更多股权的合伙人。`,
      answerBlocks: [
        { text: '我们不按传统的"拍脑袋估值"来谈，我们要的是"同舟共济"。' },
        { title: '它是动态的增长票', text: '我们现在是初创期，不想随便定个虚高估值套住您，也不想低估公司潜力。这30%是专门给首批天使投资人的"原始红利池"。' },
        { title: '您的份额由您的胆识决定', text: '如果本轮我们只需300万就能跑通市场，那您这50万就占了整个天使池的1/6，折合总股本5%。' },
        { title: '您有"二次增持"的机会', text: '除了这笔钱，如果您能利用资源帮我们拓展市场（利用那15%的贡献池），您的资金权重会被双倍放大。这意味着，您不仅是出钱的股东，您还是能通过贡献"赚"回更多股权的合伙人。' },
      ],
    },
  ];
