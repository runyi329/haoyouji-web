              ...
              <div key={key} className="py-3 px-2 text-center border-l border-gray-200">
                {key === 'digitalB' ? (
                  <div className="flex flex-col items-center gap-0.5">
                    <img src="https://haoyouji-images-1396946788.cos.ap-shanghai.myqcloud.com/assets/icons/btc-icon-trimmed.png" alt="数字B" className="w-5 h-5 rounded-full object-cover" />
