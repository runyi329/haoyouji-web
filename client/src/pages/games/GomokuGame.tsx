...
export default function GomokuGame() {
  ...
  const renderBoard = () => {
    ...
    return (
      <div 
        className="inline-grid bg-[#FAF3ED] p-2 md:p-3 rounded-lg shadow-lg"
        style={{ 
            ...
            return (
              ...
              >
                ...
                {isStarPoint(rowIndex, colIndex) && !cell && (
                  <div className="absolute w-1.5 h-1.5 bg-[#CBA471]/80 rounded-full z-10" />
                )}
            ...
            {gameMode === "ai" && (
              <Card className="p-6 max-w-sm w-full">
                ...
                <div className="mt-4 p-3 bg-muted/50 rounded-lg text-sm">
                  ...
                  <div className="flex items-center gap-1 mt-2 text-[#CBA471]">
                    <Star className="w-4 h-4 fill-current" />
