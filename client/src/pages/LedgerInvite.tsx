    ...
    <div className="min-h-screen" style={{ backgroundColor: `${'#D32F2F'}15` }}>
      ...
      <div className="container mx-auto px-4 py-6 space-y-6">
        ...
        <Card className="p-6 bg-white">
          <h2 className="text-xl font-bold mb-2" style={{ color: '#1F2937' }}>{ledger.name}</h2>
          <p className="text-gray-600">邀请伙伴一起记账</p>
        </Card>

        {/* 二维码 */}
        <Card className="p-6 bg-white flex flex-col items-center">
          <h3 className="text-lg font-semibold mb-4" style={{ color: '#1F2937' }}>扫描二维码加入</h3>
          {qrCodeUrl ? (
        ...
        {/* 邀请链接 */}
        <Card className="p-6 bg-white">
          <h3 className="text-lg font-semibold mb-4" style={{ color: '#1F2937' }}>邀请链接</h3>
          ...
          <div className="flex gap-3">
            <Button
              ...
              className="flex-1"
              style={{ backgroundColor: `${'#D32F2F'}30`, color: '#1F2937' }}
              disabled={!inviteLink}
            >
              {copied ? (
                <>
        ...
        {/* 提示信息 */}
        <Card className="p-6 bg-white">
          <h3 className="text-lg font-semibold mb-3" style={{ color: '#1F2937' }}>温馨提示</h3>
          <ul className="space-y-2 text-sm text-gray-600">
            <li className="flex items-start">
              <span className="mr-2" style={{ color: '#D32F2F' }}>•</span>
