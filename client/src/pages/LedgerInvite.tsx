...
export default function LedgerInvite() {
  ...
  return (
    <div className="min-h-screen bg-[#e0fcff]">
      {/* 顶部导航栏 */}
      ...
      <div className="container mx-auto px-4 py-6 space-y-6">
        ...
        <Card className="p-6 bg-white">
          <h2 className="text-xl font-bold text-[#404969] mb-2">{ledger.name}</h2>
          <p className="text-gray-600">邀请伙伴一起记账</p>
        </Card>

        {/* 二维码 */}
        <Card className="p-6 bg-white flex flex-col items-center">
          <h3 className="text-lg font-semibold text-[#404969] mb-4">扫描二维码加入</h3>
          {qrCodeUrl ? (
        ...
        {/* 邀请链接 */}
        <Card className="p-6 bg-white">
          <h3 className="text-lg font-semibold text-[#404969] mb-4">邀请链接</h3>
          ...
          <div className="flex gap-3">
            <Button
              ...
              className="flex-1 bg-[#bde4f4] hover:bg-[#a0d8ed] text-[#404969]"
              disabled={!inviteLink}
            >
              {copied ? (
                <>
        ...
        {/* 提示信息 */}
        <Card className="p-6 bg-white">
          <h3 className="text-lg font-semibold text-[#404969] mb-3">温馨提示</h3>
