...
2.5　乙方在执行推广任务过程中，应遵守国家法律法规及甲方的业务规范要求，不得从事任何违法违规行为。`,
  ...
  {
    title: "第三条　费用承担与成本凭证提交",
    content: `3.1　合作方为完成本项目所产生的差旅费、交通费、住宿费等，由甲方（公司）据实报销，不计入业务分成，不视为劳务报酬。

3.2　合作方为履行本协议、开展合作业务所产生的交通费、住宿费、餐饮费、业务相关采购及其他必要差旅费，由甲方据实核算，不计入业务分成，不视为甲方向合作方支付的劳务报酬、工资薪金或劳动报酬。

3.3　合作方提交业务成本凭证时，应提供抬头为甲方全称及税号的合法有效发票、支付凭证及业务佐证材料，提交至甲方存档。上述费用是否纳入最终结算、纳入金额多少，由甲方根据业务最终业绩及双方协商结果确定，甲方不承诺按凭证金额即时支付。

3.4　双方确认：本协议为平等商业合作关系，非劳动关系、非劳务雇佣关系，甲方无需为合作方缴纳社保、公积金，不承担用工相关责任。

3.5　合作方不得虚开、伪造发票或凭证，一经发现，甲方有权立即解除本协议，并有权拒绝将相关凭证纳入结算；情节严重的，甲方保留追究合作方法律责任的权利。`,
  },
  {
    title: "第四条　业务提成",
    content: `4.1　乙方在前期合作阶段不享有固定劳务报酬，甲方仅依据第三条约定，将合作方提交的业务成本凭证纳入最终业绩核算。
...
4.4　"业务实际利润"系指会员单位就该笔业务取得的实际收入，扣除直接成本（含税费、合作方本次任务已核定成本等）后的净利润，由甲方提供核算依据，乙方有权要求甲方提供相关财务凭证进行核实。
...
（三）甲方应按约定处理合作方提交的业务成本凭证，并按本协议约定支付业务提成；
（四）甲方应为乙方保密其在合作中获取的业务信息，不得将乙方个人信息用于本协议以外的用途。

5.2　乙方权利与义务：
（一）乙方有权按本协议约定提交业务成本凭证，并获取业务提成；
...
7.3　协议期内，任何一方如需提前终止合作，应提前30日以书面形式通知对方。提前终止不影响已提交的业务成本凭证及业务提成的结算。`,
  },
  {
    title: "第八条　违约责任",
          ...
          <div style={{ background: "#fff", margin: "8px 12px 0", borderRadius: 12, padding: "16px", boxShadow: "0 1px 4px rgba(0,0,0,0.06)" }}>
            ...
            <button
              ...
              style={{
                ...
                borderRadius: 12,
                border: "none",
                background: (agreed && signatureDataUrl && selectedCard) ? "#E53E3E" : "#CBD5E0",
                color: "#fff",
                fontSize: 15,
                fontWeight: 700,
