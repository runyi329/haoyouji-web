...
export const wcTeams: TeamData[] = [
  ...
  },
  {
    ...
    players: [
      ...
      { pos: "MF", name: "Granit Xhaka", nameCn: "格拉尼特·扎卡", age: 33, caps: 144, goals: 16, club: "Sunderland", captain: true },
  ...
  // ===== GROUP C =====
  {
    ...
    players: [
      ...
      { pos: "DF", name: "Marquinhos", nameCn: "马尔基尼奥斯", age: 32, caps: 104, goals: 7, club: "Paris Saint-Germain" },
  ...
  // ===== GROUP F =====
  {
    ...
    players: [
      ...
      { pos: "MF", name: "Ao Tanaka", nameCn: "田中碧", age: 27, caps: 37, goals: 8, club: "Leeds United" },
      ...
      { pos: "MF", name: "Daichi Kamada", nameCn: "镰田大地", age: 29, caps: 49, goals: 12, club: "Crystal Palace" },
  ...
  },
  {
    ...
    players: [
      ...
      { pos: "MF", name: "Frenkie de Jong", nameCn: "弗伦基·德容", age: 29, caps: 64, goals: 2, club: "Barcelona" },
  ...
  },
  {
    ...
    players: [
      ...
      { pos: "FW", name: "Mehdi Taremi", nameCn: "迈赫迪·塔雷米", age: 33, caps: 103, goals: 59, club: "Olympiacos" },
  ...
  },
  {
    ...
    players: [
      { pos: "GK", name: "Unai Simón", nameCn: "尤内·西蒙", age: 29, caps: 57, goals: 0, club: "Athletic Bilbao" },
      { pos: "GK", name: "David Raya", nameCn: "大卫·拉亚", age: 30, caps: 12, goals: 0, club: "Arsenal" },
      { pos: "DF", name: "Aymeric Laporte", nameCn: "艾默里克·拉波特", age: 32, caps: 44, goals: 2, club: "Athletic Bilbao" },
      { pos: "DF", name: "Marc Cucurella", nameCn: "马克·库库雷拉", age: 27, caps: 23, goals: 1, club: "Chelsea" },
      ...
      { pos: "DF", name: "Pau Cubarsí", nameCn: "保·库巴西", age: 19, caps: 11, goals: 0, club: "Barcelona" },
      { pos: "MF", name: "Rodri", nameCn: "罗德里", age: 29, caps: 61, goals: 4, club: "Manchester City", captain: true },
      { pos: "MF", name: "Mikel Merino", nameCn: "米克尔·梅里诺", age: 29, caps: 41, goals: 10, club: "Arsenal" },
      { pos: "MF", name: "Fabián Ruiz", nameCn: "法比安·鲁伊斯", age: 30, caps: 41, goals: 6, club: "Paris Saint-Germain" },
      ...
      { pos: "FW", name: "Ferran Torres", nameCn: "费兰·托雷斯", age: 26, caps: 55, goals: 23, club: "Barcelona" },
  ...
  // ===== GROUP I =====
  {
    ...
    players: [
      { pos: "GK", name: "Brice Samba", nameCn: "布里斯·桑巴", age: 32, caps: 4, goals: 0, club: "Rennes" },
      ...
      { pos: "FW", name: "Bradley Barcola", nameCn: "巴特利·巴高拿", age: 23, caps: 18, goals: 3, club: "Paris Saint-Germain" },
    ]
  },
  {
  ...
  },
  {
    ...
    players: [
      ...
      { pos: "MF", name: "Martin Ødegaard", nameCn: "马丁·厄德高", nameCn: "马丁·厄德高", age: 27, caps: 67, goals: 4, club: "Arsenal", captain: true },
      ...
      { pos: "FW", name: "Erling Haaland", nameCn: "厄林·哈兰德", nameCn: "厄林·哈兰德", age: 25, caps: 49, goals: 55, club: "Manchester City" },
  ...
  },
  {
    ...
    players: [
      { pos: "GK", name: "Emiliano Martínez", nameCn: "埃米利亚诺·马丁内斯", nameCn: "艾米利亚诺·马天尼斯", age: 33, caps: 59, goals: 0, club: "Aston Villa" },
      { pos: "GK", name: "Juan Musso", nameCn: "胡安·穆索", age: 32, caps: 3, goals: 0, club: "Atlético Madrid" },
      { pos: "DF", name: "Nicolás Otamendi", nameCn: "尼古拉斯·奥塔门迪", nameCn: "尼古拉斯·奥塔门迪", age: 38, caps: 130, goals: 8, club: "Benfica" },
      { pos: "DF", name: "Cristian Romero", nameCn: "克里斯蒂安·罗梅罗", nameCn: "基斯蒂安·罗美露", age: 28, caps: 49, goals: 3, club: "Tottenham Hotspur" },
      { pos: "DF", name: "Nicolás Tagliafico", nameCn: "尼古拉斯·达利亚费高", age: 33, caps: 75, goals: 1, club: "Lyon" },
      { pos: "DF", name: "Gonzalo Montiel", nameCn: "贡萨洛·蒙蒂尔", age: 29, caps: 38, goals: 2, club: "River Plate" },
      { pos: "DF", name: "Lisandro Martínez", nameCn: "利辛祛罗·马天尼斯", age: 28, caps: 26, goals: 1, club: "Manchester United" },
      { pos: "DF", name: "Nahuel Molina", nameCn: "纳韦尔·莫尔内拿", age: 28, caps: 58, goals: 1, club: "Atlético Madrid" },
      { pos: "MF", name: "Leandro Paredes", nameCn: "莱安德罗·帕雷德斯", age: 31, caps: 77, goals: 5, club: "Boca Juniors" },
      { pos: "MF", name: "Rodrigo De Paul", nameCn: "罗德里戈·德保尔", nameCn: "罗德里戈·德保罗", age: 32, caps: 85, goals: 2, club: "Inter Miami CF" },
      { pos: "MF", name: "Alexis Mac Allister", nameCn: "亚历克西斯·麦卡利斯特", nameCn: "亚历克斯·麦卡列斯特", age: 27, caps: 44, goals: 6, club: "Liverpool" },
      { pos: "MF", name: "Enzo Fernández", nameCn: "恩佐·费尔南德斯", nameCn: "恩佐·费南德斯", age: 25, caps: 40, goals: 6, club: "Chelsea" },
      ...
      { pos: "FW", name: "Lautaro Martínez", nameCn: "劳塔罗·马丁内斯", nameCn: "劳塔罗·马天尼斯", age: 28, caps: 75, goals: 36, club: "Inter Milan" },
  ...
  // ===== GROUP K =====
  {
    ...
    players: [
      ...
      { pos: "MF", name: "James Rodríguez", nameCn: "哈梅斯·罗德里格斯", age: 34, caps: 124, goals: 31, club: "Minnesota United FC", captain: true },
      ...
      { pos: "FW", name: "Luis Díaz", nameCn: "路易斯·迪亚斯", age: 29, caps: 72, goals: 21, club: "Bayern Munich" },
  ...
  },
  {
    ...
    players: [
      { pos: "GK", name: "Diogo Costa", nameCn: "迪奥戈·科斯塔", age: 26, caps: 42, goals: 0, club: "Porto" },
      { pos: "GK", name: "José Sá", nameCn: "何塞·萨", age: 33, caps: 4, goals: 0, club: "Wolverhampton Wanderers" },
      { pos: "DF", name: "Rúben Dias", nameCn: "鲁本·迪亚斯", age: 29, caps: 74, goals: 3, club: "Manchester City" },
      { pos: "DF", name: "João Cancelo", nameCn: "蔡尔·卡幼洛", age: 32, caps: 66, goals: 12, club: "Barcelona" },
      { pos: "DF", name: "Nélson Semedo", nameCn: "奈尔森·塞梅多", age: 32, caps: 48, goals: 0, club: "Fenerbahçe" },
      { pos: "DF", name: "Nuno Mendes", nameCn: "努诺·門德斯", age: 23, caps: 43, goals: 1, club: "Paris Saint-Germain" },
      { pos: "DF", name: "Diogo Dalot", nameCn: "迪奥戈·达洛特", age: 27, caps: 33, goals: 3, club: "Manchester United" },
      { pos: "DF", name: "Gonçalo Inácio", nameCn: "贡萨洛·伊纳西奥", age: 24, caps: 20, goals: 2, club: "Sporting CP" },
      { pos: "MF", name: "Bernardo Silva", nameCn: "伯纳多·辛瓦", age: 31, caps: 107, goals: 14, club: "Manchester City" },
      { pos: "MF", name: "Bruno Fernandes", nameCn: "布鲁诺·费南德斯", age: 31, caps: 87, goals: 28, club: "Manchester United" },
      { pos: "MF", name: "Rúben Neves", nameCn: "鲁本·内韦斯", age: 29, caps: 65, goals: 1, club: "Al-Hilal" },
      { pos: "MF", name: "Vitinha", nameCn: "维蒂尼亚", age: 26, caps: 37, goals: 0, club: "Paris Saint-Germain" },
      { pos: "MF", name: "João Neves", nameCn: "蔡尔·内韦斯", age: 21, caps: 21, goals: 3, club: "Paris Saint-Germain" },
      { pos: "FW", name: "Cristiano Ronaldo", nameCn: "克里斯蒂亚诺·罗纳尔多", age: 41, caps: 226, goals: 143, club: "Al-Nassr", captain: true },
      { pos: "FW", name: "João Félix", nameCn: "蔡尔·费利克斯", age: 26, caps: 52, goals: 12, club: "Al-Nassr" },
      { pos: "FW", name: "Rafael Leão", nameCn: "拉法利·利奥", age: 27, caps: 43, goals: 5, club: "Milan" },
      { pos: "FW", name: "Gonçalo Ramos", nameCn: "贡萨洛·拉莫斯", age: 24, caps: 24, goals: 10, club: "Paris Saint-Germain" },
      { pos: "FW", name: "Pedro Neto", nameCn: "佩德罗·内托", age: 26, caps: 23, goals: 2, club: "Chelsea" },
    ]
  },
  {
  ...
  // ===== GROUP L =====
  {
    ...
    players: [
      ...
      { pos: "DF", name: "Joško Gvardiol", nameCn: "沃什科·瓦尔迪奥尔", age: 24, caps: 46, goals: 4, club: "Manchester City" },
      ...
      { pos: "MF", name: "Luka Modrić", nameCn: "卢卡·莫德里奇", age: 40, caps: 196, goals: 28, club: "Milan", captain: true },
      { pos: "MF", name: "Mateo Kovačić", nameCn: "马泰奥·科瓦奇奇", age: 32, caps: 111, goals: 5, club: "Manchester City" },
      ...
      { pos: "FW", name: "Ivan Perišić", nameCn: "伊万·佩里西奇", age: 37, caps: 152, goals: 38, club: "PSV Eindhoven" },
  ...
  },
  {
    ...
    players: [
      { pos: "GK", name: "Jordan Pickford", nameCn: "乔丹·皮克福德", age: 32, caps: 82, goals: 0, club: "Everton" },
      { pos: "GK", name: "Dean Henderson", nameCn: "迪恩·亨德森", age: 29, caps: 2, goals: 0, club: "Crystal Palace" },
      { pos: "DF", name: "John Stones", nameCn: "约翰·斯托尼斯", age: 32, caps: 87, goals: 3, club: "Manchester City" },
      { pos: "DF", name: "Marc Guéhi", nameCn: "马克·盖希", age: 25, caps: 27, goals: 1, club: "Manchester City" },
      ...
      { pos: "MF", name: "Declan Rice", nameCn: "德克兰·赖斯", age: 27, caps: 72, goals: 6, club: "Arsenal" },
      { pos: "MF", name: "Jude Bellingham", nameCn: "朱德·贝林汉", age: 22, caps: 46, goals: 6, club: "Real Madrid" },
      { pos: "MF", name: "Morgan Rogers", nameCn: "摩根·罗杰斯", age: 23, caps: 13, goals: 1, club: "Aston Villa" },
      { pos: "MF", name: "Kobbie Mainoo", nameCn: "科比·马伊诺", age: 21, caps: 12, goals: 0, club: "Manchester United" },
      { pos: "FW", name: "Harry Kane", nameCn: "哈里·凯恩", age: 32, caps: 112, goals: 78, club: "Bayern Munich", captain: true },
      { pos: "FW", name: "Marcus Rashford", nameCn: "马库斯·拉什福德", age: 28, caps: 70, goals: 18, club: "Barcelona" },
      { pos: "FW", name: "Bukayo Saka", nameCn: "布卡辟·萨卡", age: 24, caps: 48, goals: 14, club: "Arsenal" },
      { pos: "FW", name: "Ollie Watkins", nameCn: "奥利·沃金斯", age: 30, caps: 20, goals: 6, club: "Aston Villa" },
