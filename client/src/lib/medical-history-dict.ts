...
export const MEDICAL_HISTORY_DICT: MedicalHistoryItem[] = [
  ...
  { id: "in_2", name: "丙型肝炎", category: "传染病", pinyin: "bxgy", aliases: ["丙肝"] },
  { id: "in_3", name: "结核病", category: "传染病", pinyin: "jhb", aliases: ["肺结核", "结核"], relatedTags: ["活动性结核", "已治愈", "正在抗结核治疗"] },
  { id: "in_4", name: "梅毒", category: "传染病", pinyin: "md", aliases: ["TP阳性"] },
  { id: "in_5", name: "艾滋病/HIV", category: "传染病", pinyin: "azbhiv", aliases: ["HIV", "艾滋", "HIV阳性"] },
  { id: "in_6", name: "新冠/呼吸道传染病", category: "传染病", pinyin: "xghxdcrb", aliases: ["新冠", "新冠阳性", "甲流", "流感"] },
  { id: "in_7", name: "带状疱疹/单纯疱疹", category: "传染病", pinyin: "dzpzdcpz", aliases: ["带状疱疹", "缠腰龙", "唇疱疹", "上火起泡"] },
  { id: "in_8", name: "手足口病", category: "传染病", pinyin: "szkb", aliases: ["手足口"] },
  { id: "in_9", name: "HPV感染", category: "传染病", pinyin: "hpvgr", aliases: ["人乳头瘤病毒", "尖锐湿疣"] },
