  ...
  return (
    <div className="space-y-4">
      ...
      <div className="flex items-center justify-between">
        <h3 className="text-sm font-semibold text-[#424242]">公司全球股权分配架构</h3>
      ...
      <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-xl p-5">
        ...
        <div className="mt-4 pt-4 border-t border-white/10">
          <div className="flex items-start space-x-2">
            <Shield className="w-4 h-4 text-[#4CAF50] flex-shrink-0 mt-0.5" />
            <div className="flex-1">
              <p className="text-xs text-gray-300 leading-relaxed">
                <span className="font-semibold text-white">透明承诺：</span>
                所有股权池比例已在《公司章程》中明确约定，
                <span className="text-[#4CAF50] font-semibold">预留期权池</span>
                专用于未来融资及核心员工激励，
                <span className="text-[#D32F2F] font-semibold">投资股份池</span>
        ...
        <div className="mt-4 grid grid-cols-3 gap-3">
          <div className="bg-white/5 rounded-lg p-2.5 border border-white/10">
            <div className="text-xs text-[#757575] mb-1">创始股东数</div>
            <div className="text-xl font-bold text-white">660</div>
          </div>
          <div className="bg-white/5 rounded-lg p-2.5 border border-white/10">
            <div className="text-xs text-[#757575] mb-1">当前估值</div>
            <div className="text-xl font-bold text-white">6600万</div>
          </div>
          <div className="bg-white/5 rounded-lg p-2.5 border border-white/10">
            <div className="text-xs text-[#757575] mb-1">期权池余额</div>
            <div className="text-xl font-bold text-[#4CAF50]">25%</div>
          </div>
        </div>
      </div>
