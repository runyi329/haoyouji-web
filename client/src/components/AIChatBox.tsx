      ...
      >
        <div className="flex flex-col h-full">
          ...
          <div className="flex items-center justify-between p-4 border-b border-gray-200">
            <h2 className="text-sm font-semibold text-gray-800">对话历史</h2>
            <button
          ...
          <div className="p-3 border-b border-gray-200">
            <button
              ...
              className="w-full flex items-center gap-2 px-3 py-2 text-xs text-gray-700 bg-white border border-gray-300 rounded-lg hover:bg-gray-50"
            >
                ...
                <div className="flex max-w-2xl flex-col gap-2 w-full px-4">
                  {suggestedPrompts.map((prompt, index) => (
                    <button
                      ...
                      disabled={isLoading}
                      className="rounded-lg bg-gray-50 px-4 py-3 text-sm text-left hover:bg-gray-100 transition-colors disabled:cursor-not-allowed disabled:opacity-50 border border-gray-200"
                    >
                      {prompt}
                    </button>
                  ))}
                  ...
                  <div className="flex gap-4 items-start max-w-3xl mx-auto">
                    ...
                    <div className="flex-1 min-w-0">
                      {message.role === "assistant" ? (
                        <div className="prose prose-sm max-w-none text-sm text-gray-800 break-words">
          ...
          >
            <div className="flex gap-3 items-end">
              <Textarea
                ...
                className="flex-1 max-h-32 resize-none min-h-[44px] bg-gray-50 border-gray-200 focus-visible:ring-1 focus-visible:ring-[#A80000] rounded-lg px-4 py-3 text-sm"
                rows={1}
              />
              <Button
                type="submit"
