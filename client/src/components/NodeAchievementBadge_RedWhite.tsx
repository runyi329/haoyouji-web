      ...
      <div className="space-y-0">
        ...
        <div className={`relative overflow-hidden p-4 rounded-t-2xl ${getTopCardStyle()}`}>
          ...
          <div className="flex items-center justify-between mb-3">
            <span className={`text-sm font-medium ${level === 'none' ? 'text-[#757575]' : 'opacity-90'}`}>
              市场贡献激励
            </span>
            <div className="flex items-center space-x-2">
              {/* 倒计时 */}
              <span className={`text-[10px] font-mono ${level === 'none' ? 'text-[#757575]' : 'opacity-60'} bg-white/10 px-2 py-0.5 rounded flex items-center space-x-1`}>
        ...
        <div className="bg-[#F9F9F9] rounded-b-3xl p-4 space-y-5">
            ...
            <div className="space-y-2.5">
              ...
              <div>
                <div className="flex items-center justify-between mb-1">
                  ...
                  <span className={`text-[10px] font-medium ${contactCount >= (nextTier?.contactMin || 50) ? 'text-[#C5B358]' : 'text-[#757575]'}`}>
              ...
              <div>
                <div className="flex items-center justify-between mb-1">
                  ...
                  <span className={`text-[10px] font-medium ${tagAverage >= (nextTier?.tagMin || 1) ? 'text-[#C5B358]' : 'text-[#757575]'}`}>
              ...
              <div>
                <div className="flex items-center justify-between mb-1">
                  ...
                  <span className={`text-[10px] font-medium ${contactFrequency >= (nextTier?.frequencyMin || 3) ? 'text-[#C5B358]' : 'text-[#757575]'}`}>
          ...
          <div>
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center justify-between py-2 border-b border-[#E0E0E0]">
                ...
                {standardNodeCount > 0 ? (
                  ...
                  <div className="flex items-center justify-between w-full">
                    <span className="text-lg font-bold text-[#757575]">0</span>
              ...
              {/* 已培育高级节点 */}
              <div className="flex items-center justify-between py-2 border-b border-[#E0E0E0]">
                <span className="text-xs text-[#757575]">已培育高端节点</span>
                {advancedNodeCount > 0 ? (
              ...
              {/* 已培育超级节点 */}
              <div className="flex items-center justify-between py-2 border-b border-[#E0E0E0]">
                <span className="text-xs text-[#757575]">已培育超端节点</span>
                <div className="flex items-center justify-between w-full">
                  <span className="text-lg font-bold text-[#757575]">0</span>
                  <span className="text-[#C5B358]">→</span>
                </div>
          ...
          <div className="pt-3 border-t border-[#E0E0E0] space-y-3">
            ...
            <div className="flex items-center justify-center space-x-3 text-xs">
              <button
                onClick={() => setShowRules(true)}
                className="flex items-center space-x-1 px-3 py-2 rounded-lg border border-[#E0E0E0] bg-white hover:border-[#A80000] hover:bg-[#FFEBEE] transition-all text-[#757575] hover:text-[#A80000]"
              >
                ...
                <table className="w-full text-xs border-collapse">
                  <thead>
                    <tr className="bg-gray-50">
                      <th className="border border-[#E0E0E0] px-2 py-2 text-left font-semibold text-[#424242]">等级</th>
                      <th className="border border-[#E0E0E0] px-2 py-2 text-left font-semibold text-[#424242]">人脉规模</th>
                      <th className="border border-[#E0E0E0] px-2 py-2 text-left font-semibold text-[#424242]">标签完善</th>
                      <th className="border border-[#E0E0E0] px-2 py-2 text-left font-semibold text-[#424242]">联络频率</th>
                      <th className="border border-[#E0E0E0] px-2 py-2 text-left font-semibold text-[#424242]">节点培育</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr>
                      <td className="border border-[#E0E0E0] px-2 py-2 font-medium text-[#424242]">标准节点</td>
                      <td className="border border-[#E0E0E0] px-2 py-2 text-[#757575]">≥50人</td>
                      <td className="border border-[#E0E0E0] px-2 py-2 text-[#757575]">≥1标签/人</td>
                      <td className="border border-[#E0E0E0] px-2 py-2 text-[#757575]">≥3人/日</td>
                      <td className="border border-[#E0E0E0] px-2 py-2 text-[#757575]">-</td>
                    </tr>
                    <tr>
                      <td className="border border-[#E0E0E0] px-2 py-2 font-medium text-[#424242]">高级节点</td>
                      <td className="border border-[#E0E0E0] px-2 py-2 text-[#757575]">≥100人</td>
                      <td className="border border-[#E0E0E0] px-2 py-2 text-[#757575]">≥3标签/人</td>
                      <td className="border border-[#E0E0E0] px-2 py-2 text-[#757575]">≥6人/日</td>
                      <td className="border border-[#E0E0E0] px-2 py-2 text-[#757575]">≥5个标准节点</td>
                    </tr>
                    <tr>
                      <td className="border border-[#E0E0E0] px-2 py-2 font-medium text-[#424242]">超级节点</td>
                      <td className="border border-[#E0E0E0] px-2 py-2 text-[#757575]">≥150人</td>
                      <td className="border border-[#E0E0E0] px-2 py-2 text-[#757575]">≥5标签/人</td>
                      <td className="border border-[#E0E0E0] px-2 py-2 text-[#757575]">≥9人/日</td>
                      <td className="border border-[#E0E0E0] px-2 py-2 text-[#757575]">≥5个高级节点</td>
                    </tr>
                  </tbody>
                </table>
              </div>

              <div className="mt-4 text-xs text-[#757575] space-y-2">
