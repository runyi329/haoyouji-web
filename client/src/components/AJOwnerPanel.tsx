            ...
            {selectedEmployee && (
              ...
              >
                ...
                <div style={{
                  ...
                  <div style={{ textAlign: 'center' }}>
                    <div style={{ color: '#FCD34D', fontSize: '11px', fontWeight: 700, borderBottom: '1px dashed rgba(252,211,77,0.4)', display: 'inline-block' }}>
                      ¥{employeeStats ? employeeStats.pending.amount.toFixed(0) : '--'}
                    </div>
                  </div>
                  <div style={{ textAlign: 'center' }}>
                    <div style={{ color: '#81C784', fontSize: '11px', fontWeight: 700 }}>
                ...
                <div style={{
                  ...
                  <div style={{ textAlign: 'center' }}>
                    <div style={{ color: '#FCD34D', fontSize: '11px', fontWeight: 700, borderBottom: '1px dashed rgba(252,211,77,0.4)', display: 'inline-block' }}>
                      ...
                      <span style={{ fontSize: '9px', color: 'rgba(255,255,255,0.4)', marginLeft: '1px' }}>U</span>
                    </div>
                  </div>
                  <div style={{ textAlign: 'center' }}>
                    <div style={{ color: '#81C784', fontSize: '11px', fontWeight: 700 }}>
